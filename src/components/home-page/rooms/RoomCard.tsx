	...
	return (
		<div className="col-span-12 xl:col-span-4 p-3 rounded-xl bg-white">
			...
			<div className="flex flex-col gap-6 mt-4">
				...
				<Button
					asChild
					className="bg-greenBrand font-urbanist h-14 rounded-full w-fit text-base sm:text-lg font-semibold hover:bg-opacity-80 hover:bg-greenBrand self-end"
					size={"lg"}
				>
					<Link href={`room/${urlDetails}`}>Pesan ruangan</Link>
				</Button>
			</div>
		</div>
	)
